...
import com.viktor.kh.dev.shoplist.repository.db.room.migrationUtils.AutoMigrationListsFrom2To3


@Database(entities = [DataProductList::class], version = 3,
    autoMigrations = [
        AutoMigration(from = 1, to = 2),
        AutoMigration(from = 2, to = 3, spec = AutoMigrationListsFrom2To3::class)]
)
